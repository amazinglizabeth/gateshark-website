      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
        ...
        <div className="space-y-6 sm:space-y-8">
          {workflowSteps.map((step) => (
            ...
            >
              <h3
                className={`font-inter-tight text-lg sm:text-[24px] font-medium ${
              ...
              {step.description && (
                <p className="font-inter-tight text-gray-600 font-normal text-sm sm:text-[16px]">
                  {step.description}
                </p>
              )}
            </div>
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-5 overflow-hidden">
        ...
        <div className="md:col-span-3 bg-[#1b5e39] text-white p-6 xs:p-8 sm:p-12 md:p-16 lg:p-20 flex flex-col justify-between space-y-8 sm:space-y-10">
          <div className="space-y-4 sm:space-y-6 max-w-xl">
            ...
            <h2 className="font-inter-tight text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-[52px] font-medium leading-tight sm:leading-[1.15]">
              {bannerData.heading}
            </h2>
            <p className="font-gelix-TRIAL text-gray-200 text-sm sm:text-base md:text-[18px] leading-relaxed font-normal">
          ...
          <div>
            <a
              ...
              className="font-inter-tight bg-[#9bf072] text-[#132C24] text-sm sm:text-[16px] font-medium px-4 py-3 sm:py-3.5 rounded-xl flex items-center gap-2.5 hover:opacity-90 transition cursor-pointer"
            >
              <img
